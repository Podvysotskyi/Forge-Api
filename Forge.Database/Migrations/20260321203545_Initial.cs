    ...
    public partial class Initial : Migration
    {
        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                constraints: table =>
                {
                    ...
                    table.ForeignKey(
                        ...
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrganizationUsers_Statuses_StatusId",
                        column: x => x.StatusId,
                        principalTable: "Statuses",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateTable(
                ...
                {
                    PermissionsId = table.Column<int>(type: "integer", nullable: false),
                    OrganizationUsersOrganizationId = table.Column<Guid>(type: "uuid", nullable: false),
                    OrganizationUsersUserId = table.Column<Guid>(type: "uuid", nullable: false)
                },
                constraints: table =>
                {
                    table.PrimaryKey("PK_OrganizationUserPermission", x => new { x.PermissionsId, x.OrganizationUsersOrganizationId, x.OrganizationUsersUserId });
                    table.ForeignKey(
                        name: "FK_OrganizationUserPermission_OrganizationUsers_OrganizationUs~",
                        columns: x => new { x.OrganizationUsersOrganizationId, x.OrganizationUsersUserId },
                        principalTable: "OrganizationUsers",
                        principalColumns: new[] { "OrganizationId", "UserId" },
                        onDelete: ReferentialAction.Cascade);
                    table.ForeignKey(
                        name: "FK_OrganizationUserPermission_Permissions_PermissionsId",
                        column: x => x.PermissionsId,
                        principalTable: "Permissions",
                        principalColumn: "Id",
                        onDelete: ReferentialAction.Cascade);
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationUserPermission_OrganizationUsersOrganizationId_~",
                table: "OrganizationUserPermission",
                columns: new[] { "OrganizationUsersOrganizationId", "OrganizationUsersUserId" });
            ...
            migrationBuilder.CreateIndex(
                name: "IX_OrganizationUsers_StatusId",
                table: "OrganizationUsers",
                column: "StatusId");
